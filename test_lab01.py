...
def test_parse_resume():
    r = Resume(id="1", cand_id="1", text="Python developer with 3 years in Almaty. Bachelor degree.", parsed={})
...
def test_filter_by_skill():
    c1 = Candidate(id="1", name="A", skills=("python",), exp_years=2, location="almaty", edu="bachelor")
    c2 = Candidate(id="2", name="B", skills=("java",), exp_years=3, location="astana", edu="master")
